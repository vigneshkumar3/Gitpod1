...
return [
    ...
    'audit_interval_help'       => 'Ako se od vas traži da redovno vršite fizičku reviziju svoje imovine, unesite interval u mesecima koji koristite. Ako ažurirate ovu vrednost, svi „sledeći datumi revizije“ za sredstva sa predstojećim datumom revizije.',
    ...
    'ldap_activated_flag_help'  => 'Ova zastavica se koristi za određivanje da li korisnik može da se prijavi na Snipe-IT i ne utiče na mogućnost da se stavke prijave ili odu u njih.',
    ...
    'saml_forcelogin_label'     => 'SAML podrazumevani nalog',
    ...
    'slack_integration_help'    => 'Slack integracija je opciona, međutim krajnja tačka i kanal su potrebni ako želite da je koristite. Da biste konfigurisali Slack integraciju, prvo morate da <a href=":slack_link" target="_nev" rel="noopener">napravite dolazni veb-huk</a> na svom Slack nalogu. Kliknite na dugme <strong>Testiraj Slack integraciju</strong> da biste potvrdili da su vaša podešavanja tačna pre nego što ih sačuvate. ',
    'slack_integration_help_button'    => 'Kada sačuvate svoje Slack informacije, pojaviće se dugme za testiranje.',
